...
<html>
					...
					<table class="table table-striped table-hover table-bordered">
						...
						<tr>
							...
							<td>
								...
								<a href="delete.php?email=<?php echo $res['email']; ?>" class="text-white">Delete</a>
								</button>
							</td>
							<td>
								<button class="btn-primary btn">
								<a href="update.php?email=<?php echo $res['email']; ?>" class="text-white">update</a>
								</button>
							</td>
						</tr>
						<?php
  ...
  <style>
	...
	<div class="center-container">
		...
		<h1 class="reviewer-name"><font size="6px">To add a member:</font></h1>
		<a href="insert.php" class="btn-primary btn">Insert</a>
	</div>
