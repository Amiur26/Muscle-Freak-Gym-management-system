...
<div class="col-lg-12">
<br><br>
<h1 class="text-warning text-center">Display yogaclass data</h1>
<br>
...
<?php
include 'conn.php';
$q="select * from yogaClass";
$query=mysqli_query($con,$q);
while($res=mysqli_fetch_array($query)){
?>
<tr>
<td> <?php echo $res['CID']; ?> </td>
<td> <?php echo $res['yogaType']; ?> </td>
<td> <?php echo $res['IID']; ?> </td>
<td>
<button class="btn-danger btn">
<a href="deleteYCadmin.php?CID=<?php echo $res['CID']; ?>"
class="text-white">Delete</a>
</button>
</td>
<td>
<button class="btn-primary btn">
<a href="updateYCadmin.php?CID=<?php echo $res['CID']; ?>"
...
<style>
  ...
  <div class="center-container">
    ...
    <h1 class="reviewer-name"><font size="6px">To add yoga class:</font></h1>
    <a href="insertYCadmin.php" class="btn-primary btn">Insert</a>
  </div>
