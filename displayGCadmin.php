...
<html>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
			...
			<div class="container">
				<div class="col-lg-12">
					<br><br>
					<h1 class="text-warning text-center">Display gym class data</h1>
					<br>
					<table class="table table-striped table-hover table-bordered">
						...
						<tr>
							...
							<td>
								...
								<a href="deleteGCadmin.php?CID=<?php echo $res['CID']; ?>"
								class="text-white">Delete</a>
								</button>
							</td>
							<td>
								<button class="btn-primary btn">
								<a href="updateGCadmin.php?CID=<?php echo $res['CID']; ?>"
	...
	<div class="center-container">
		...
		<h1 class="reviewer-name"><font size="6px">To add a gym class:</font></h1>
		<a href="insertGCadmin.php" class="btn-primary btn">Insert</a>
	</div>
