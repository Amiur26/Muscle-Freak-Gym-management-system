...
<html>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
			...
			<div class="container">
				<div class="col-lg-12">
					<br><br>
					<h1 class="text-warning text-center">Display instructors data</h1>
					<br>
					<table class="table table-striped table-hover table-bordered">
						...
						<tr>
							...
							<td> <?php echo $res['yogaflag']; ?>
							</td>
							<td>
								<button class="btn-danger btn">
								<a href="deleteInsAdmin.php?IID=<?php echo $res['IID']; ?>"
								class="text-white">Delete</a>
								</button>
							</td>
							<td>
								<button class="btn-primary btn">
								<a href="updateInsAdmin.php?IID=<?php echo $res['IID']; ?>"
	...
	<div class="center-container">
		...
		<h1 class="reviewer-name"><font size="6px">To add a Instructor:</font></h1>
		<a href="insertInsAdmin.php" class="btn-primary btn">Insert</a>
	</div>
