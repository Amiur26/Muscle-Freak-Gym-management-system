...
$query="insert into yogaClass
values ('$CID','$yogaType','$IID')";
				...
				<form method="post">
					<br><div class="card">
						<div class="card-header bg-dark">
							<h1 class="text-white text-center">Insert yoga class
							operation</h1>
						</div><br>
						<label>CID:</label>
						...
						<input type="text" name="yogaType" class="form-control"> <br>
